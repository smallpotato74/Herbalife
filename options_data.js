window.OPTIONS_DATA = {
  "generated_at": "2026-06-22 04:58 UTC",
  "source": "DEMO(合成數據)",
  "config": {
    "min_dte": 30,
    "max_dte": 60,
    ...
    },
    {
      ...
      "picks": [
        ...
        },
        {
          ...
          "spread_pct": 0.014,
          "reasons": [
            "流動性 17/25 (OI=1218,spr=1.4%)",
            "Delta 0.30 → 25/25 (目標0.15-0.3)",
            "到價配合 8/25 (距strike=12.00, 1SD(IV)=34.44, ATR移動=36.16)",
            "IV regime 16/25 (IV/HV=1.32)"
          ]
        },
        {
          ...
          "spread_pct": 0.024,
          "reasons": [
            "流動性 11/25 (OI=823,spr=2.4%)",
            "Delta 0.24 → 25/25 (目標0.15-0.3)",
            "到價配合 14/25 (距strike=15.00, 1SD(IV)=26.75, ATR移動=28.09)",
            "IV regime 16/25 (IV/HV=1.32)"
          ]
        }
      ]
